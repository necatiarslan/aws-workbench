...
class FolderManager {
     ...
     */
    static async showFolderQuickPick(session, serviceId) {
        const items = [];
     ...
     */
    static addFolderItemsToQuickPick(items, folders, session, indent) {
     ...
     */
    static async createNewFolder(session) {
     ...
     */
    static getDisplayName(resource) {
     ...
     */
    static async showFilterFolderQuickPick(session) {
        const items = [];
        // Add "Show All" option
        items.push({
     ...
     */
    static async showFilterResourceNameInput(currentFilter) {
     ...
     */
    static filterItems(items, folderFilter, resourceNameFilter) {
        let filtered = items;
        // Filter by folder
        if (folderFilter) {
