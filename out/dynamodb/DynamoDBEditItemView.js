...
exports.DynamoDBEditItemView = void 0;
/* eslint-disable @typescript-eslint/naming-convention */
const vscode = require("vscode");
const ui = require("../common/UI");
const api = require("./API");
class DynamoDBEditItemView {
    static Current;
    panel;
    disposables = [];
    extensionUri;
    state;
    onItemUpdatedCallback;
    constructor(panel, extensionUri, region, tableName, tableDetails, item, onItemUpdated) {
        this.panel = panel;
    ...
    static Render(extensionUri, region, tableName, tableDetails, item, onItemUpdated) {
        ...
        const panel = vscode.window.createWebviewPanel("DynamoDBEditItemView", `Edit Item: ${tableName}`, vscode.ViewColumn.One, { enableScripts: true, retainContextWhenHidden: true });
    ...
    async updateItem(updates, removals) {
        try {
            ...
            const result = await api.UpdateItem(this.state.region, this.state.tableName, key, updateExpression, Object.keys(expressionAttributeValues).length > 0 ? expressionAttributeValues : undefined, expressionAttributeNames);
    ...
    itemToAttributes() {
        ...
        return attributes.sort((a, b) => {
            ...
            if (a.name === details.partitionKey?.name) {
                return -1;
            }
            if (b.name === details.partitionKey?.name) {
                return 1;
            }
...
exports.DynamoDBEditItemView = DynamoDBEditItemView;
//# sourceMappingURL=DynamoDBEditItemView.js.map