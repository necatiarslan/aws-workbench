...
exports.EmrInfoGroupNode = void 0;
const vscode = __importStar(require("vscode"));
const ui = __importStar(require("../common/UI"));
const NodeBase_1 = require("../tree/NodeBase");
const EmrInfoNode_1 = require("./EmrInfoNode");
class EmrInfoGroupNode extends NodeBase_1.NodeBase {
    ...
    async handleLoadChildren() {
        ...
        try {
            ...
            for (const item of infoItems) {
                new EmrInfoNode_1.EmrInfoNode(item.key, item.value, this);
            }
        }
        catch (error) {
...
exports.EmrInfoGroupNode = EmrInfoGroupNode;
//# sourceMappingURL=EmrInfoGroupNode.js.map