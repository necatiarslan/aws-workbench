...
exports.EmrTagsGroupNode = void 0;
const vscode = __importStar(require("vscode"));
const ui = __importStar(require("../common/UI"));
const NodeBase_1 = require("../tree/NodeBase");
const EmrTagNode_1 = require("./EmrTagNode");
class EmrTagsGroupNode extends NodeBase_1.NodeBase {
    ...
    async handleLoadChildren() {
        ...
        try {
            ...
            for (const tag of tags) {
                new EmrTagNode_1.EmrTagNode(tag.Key ?? "", tag.Value ?? "", this);
            }
...
exports.EmrTagsGroupNode = EmrTagsGroupNode;
//# sourceMappingURL=EmrTagsGroupNode.js.map