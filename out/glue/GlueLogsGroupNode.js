...
exports.GlueLogsGroupNode = void 0;
const NodeBase_1 = require("../tree/NodeBase");
const vscode = require("vscode");
const GlueJobNode_1 = require("./GlueJobNode");
const api = require("./API");
const ui = require("../common/UI");
class GlueLogsGroupNode extends NodeBase_1.NodeBase {
...
exports.GlueLogsGroupNode = GlueLogsGroupNode;
class GlueLogStreamGroupNode extends NodeBase_1.NodeBase {
    LogGroupName;
    constructor(label, logGroupName, parent) {
        super(label, parent);
...
class GlueLogStreamNode extends NodeBase_1.NodeBase {
    LogGroupName;
    LogStreamName;
    constructor(logStreamName, logGroupName, parent) {
...
//# sourceMappingURL=GlueLogsGroupNode.js.map