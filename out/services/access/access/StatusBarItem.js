...
class StatusBarItem {
    ...
    static Current;
    context;
    awsAccessStatusBarItem;
    awsRefreshStatusBarItem;
    awsProfileStatusBarItem;
    Text = StatusBarItem.LoadingText;
    ToolTip = "Loading ...";
    ActiveProfile = "default";
    IniData;
    AwsLoginShellCommand;
    AwsLoginShellCommandList = {};
    Timer;
    IsAwsLoginCommandExecuted = false;
    IsAutoLoginPaused = false;
    IsMeWhoRefreshedTheCredentials = false;
    IsCopyCredentialsToDefaultProfile = false;
