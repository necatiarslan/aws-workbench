...
exports.QueryTablePanel = void 0;
/* eslint-disable @typescript-eslint/naming-convention */
const vscode = require("vscode");
const api = require("../common/API");
const ui = require("../common/UI");
class QueryTablePanel {
    static currentPanel;
    _panel;
    _extensionUri;
    _disposables = [];
    ...
    _tableName;
    _tableDetails;
    static async createOrShow(extensionUri, region, tableName, tableDetails) {
        ...
        const panel = vscode.window.createWebviewPanel('queryDynamodbTable', `Query: ${tableName}`, column || vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    async _handleEditItem(item) {
        try {
            ...
            const { EditItemPanel } = await Promise.resolve().then(() => require('./EditItemPanel'));
            await EditItemPanel.createOrShow(this._extensionUri, this._region, this._tableName, this._tableDetails, item, () => {
    ...
    async _handleAddItem() {
        try {
            ...
            await AddItemPanel.createOrShow(this._extensionUri, this._region, this._tableName, this._tableDetails, async (addedItem) => {
    ...
    async _handleQuery(params) {
        ...
        try {
            ...
            // Execute query
            const result = await api.QueryTable(this._region, this._tableName, keyConditionExpression, expressionAttributeValues, undefined, params.limit || 100);
            if (result.isSuccessful) {
...
exports.QueryTablePanel = QueryTablePanel;
function getNonce() {
    let text = '';
...
//# sourceMappingURL=QueryTablePanel.js.map