...
class ScanTablePanel {
    ...
    static async createOrShow(extensionUri, region, tableName, tableDetails) {
        ...
        const panel = vscode.window.createWebviewPanel('scanDynamodbTable', `Scan: ${tableName}`, column || vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    async _handleScan(params) {
        ...
        try {
            ...
            // Execute scan
            const result = await api.ScanTable(this._region, this._tableName, params.limit || 100);
            if (result.isSuccessful) {
...
exports.ScanTablePanel = ScanTablePanel;
function getNonce() {
    let text = '';
...
//# sourceMappingURL=ScanTablePanel.js.map