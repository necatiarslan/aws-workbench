...
class AIHandler {
    ...
    static MAX_TOKEN_BUDGET_RATIO = 0.75; // Use 75% of model's max tokens
    static MAX_TOOL_RESULT_CHARS = 8000; // ~2000 tokens per result
    static MAX_RESOURCES_TO_KEEP = 5; // Limit resource context
    static SLIDING_WINDOW_SIZE = 10; // Keep last N messages in loop
    latestResources = {};
