...
class CloudWatchLogView {
    ...
    HideText = "";
    FilterText = "";
    WrapText = true; // Default to wrapped text
    UseDateTimeFilter = false; // Date/Time filter checkbox
    ...
    _getWebviewContent(webview, extensionUri) {
        ...
        const mainUri = ui.getUri(webview, extensionUri, ["media", "s3", "cloudwatch", "main.js"]);
        const styleUri = ui.getUri(webview, extensionUri, ["media", "s3", "cloudwatch", "style.css"]);
