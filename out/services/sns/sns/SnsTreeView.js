...
class SnsTreeView {
    ...
    LoadState() {
        ...
        try {
            let TopicListTemp = this.context.globalState.get('TopicList');
            if (TopicListTemp) {
                this.TopicList = TopicListTemp;
            }
    ...
    async RemoveTopic(node) {
        ...
        if (node.TreeItemType !== SnsTreeItem_1.TreeItemType.Topic) {
            return;
        }
    ...
    async PublishMessage(node) {
        ...
        let message = "";
        if (node.TreeItemType === SnsTreeItem_1.TreeItemType.PublishFile) {
    ...
    async AddMessageFilePath(node) {
        ...
        if (node.TreeItemType !== SnsTreeItem_1.TreeItemType.PublishGroup) {
            return;
        }
...
exports.SnsTreeView = SnsTreeView;
//# sourceMappingURL=SnsTreeView.js.map