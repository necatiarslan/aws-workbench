...
exports.SQSReceiveGroupNode = void 0;
const NodeBase_1 = require("../tree/NodeBase");
const vscode = require("vscode");
const api = require("./API");
const ui = require("../common/UI");
const SQSQueueNode_1 = require("./SQSQueueNode");
const SQSReceivedMessageNode_1 = require("./SQSReceivedMessageNode");
class SQSReceiveGroupNode extends NodeBase_1.NodeBase {
    ...
    ClearReceivedMessages() {
        ...
        const messagesToRemove = this.Children.filter(child => child instanceof SQSReceivedMessageNode_1.SQSReceivedMessageNode);
    ...
    async handleNodeRun() {
        ...
        this.StartWorking();
        try {
            const result = await api.ReceiveMessages(queueNode.Region, queueNode.QueueUrl, maxMessages, waitTime);
            ...
            for (const message of result.result) {
                new SQSReceivedMessageNode_1.SQSReceivedMessageNode(message, this);
            }
...
exports.SQSReceiveGroupNode = SQSReceiveGroupNode;
//# sourceMappingURL=SQSReceiveGroupNode.js.map